...
class FormDiagnostic extends React.Component{
    state = {
     ...
     handleSubmit = (oEvt) => {
        oEvt.preventDefault();
        const folderPatient = {observation: this.state.multiline, pathologie: this.state.pathologie, traitement: this.state.traitement};
        this.props._AddPatientFolder(folderPatient);
        this.setState({multiline: '',checkedA: false,checkedB: false,checkedC: false,checkedD: false, pathologie:' ', traitement: ' '});
