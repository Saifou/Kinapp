...
state ={ patient:[], patientFolder:[]}; 
  ...
  render(){
    return(
      <div>
      <Header  patientFolder={this.props.patientFolder} patient={this.props.patient} _TraitementDone={this.props._TraitementDone} _TraitementImpossible={this.props._TraitementImpossible}/>
      <PatientTitle/> 
...
const mapStateToProps = (state) =>{ // on map le state du Store Redux
  return{
    ...
    detailDialogue : state.detailDialogue  
  }
}
