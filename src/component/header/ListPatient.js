                    ...
                    {         
                        props.patient.map(patient => {
                            ...
                            <div>
                                ...
                                <MappingDialogue _TraitementDone={props._TraitementDone} _TraitementImpossible={props._TraitementImpossible} patientFolder={patientFolders} className ="detailDialoguePlace"/>
                            </div>
                            )
                        })
                    }           
